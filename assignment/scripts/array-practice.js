...
let favoriteFoods = ['tacos', 'Sushi', 'pasta'];
...
//you can be certain that it worked by adding a console log.
console.log('Added dessert to the end of array:', favoriteFoods);
...
console.log('added entree to the beginning of array,', favoriteFoods)
...
console.log('Updated array list:', colors);
...
console.log('Removed first element:', firstColor);
